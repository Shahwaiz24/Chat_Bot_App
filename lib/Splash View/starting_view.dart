                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Image(
                          image: AssetImage('assets/images/animIcon.png',),fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    SizedBox(height: screenHeight * 0.018,),
                    Text('©2030 atom. All rights reserved.', style: TextStyle(color: Utils.TextGreyColor.withOpacity(0.7), fontSize: screenHeight * 0.013),)
                  ],
                ),
              ),
            ],
